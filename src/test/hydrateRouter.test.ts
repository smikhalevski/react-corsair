import { createRoute, hydrateRouter, RoutePresenterState, Router } from '../main';
...
describe('hydrateRouter', () => {
  ...
  test('hydrates a post-populated root route presenter', async () => {
    ...
    const promise0 = router.rootPresenter!.promise;
    ...
    expect(router.rootPresenter!.promise).toBe(null);
  ...
  test('hydrates a post-populated nested route presenter', async () => {
    ...
    expect(router.rootPresenter!.promise).not.toBe(null);
    ...
    const promise1 = router.rootPresenter!.childPresenter!.promise;
    ...
    expect(router.rootPresenter!.childPresenter!.promise).toBe(null);
